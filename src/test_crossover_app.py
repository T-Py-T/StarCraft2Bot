...
def test_crossover_app_launch():
    ...
    launcher_script = crossover_app / "Contents/SharedSupport/CrossOver/CrossOver-Hosted Application/run"
    ...
    try:
        ...
        result = subprocess.run([str(launcher_script), "--list-bottles"], 
...
def test_direct_wine_with_env():
    ...
    try:
        ...
        result = subprocess.run([wine_exe, sc2_exe, "--help"], 
